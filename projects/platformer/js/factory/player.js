...
(function (window) {
    ...
    opspark.createPlayer = function (game) {
        ...
        function createFlyingJumpState(name) {
            ...
            state.enter = function() {
                ...
                asset.body.velocity.x = 20 * _direction;
                asset.x += xOffset * _direction;
                asset.y += yOffset;
            };
            state.exit = function() {
        ...
        function run() {
            ...
            asset.body.velocity.x = 900 * _direction;
    ...
    function init(game) {
        ...
        animations.jump = asset.animations.add('jump', Phaser.Animation.generateFrameNames('jump-', 1, 24, '.png', 4), 30, true);
